...
let CommentaireComponent = class CommentaireComponent {
    constructor() {
...
EditDataComponent.ctorParameters = () => [
...
let EditViewComponent = class EditViewComponent {
    constructor(codeset) {
...
EditViewComponent.ctorParameters = () => [
...
let FeedActuComponent = class FeedActuComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let MessagePageComponent = class MessagePageComponent {
    constructor() { }
    ngOnInit() {
    }
};
